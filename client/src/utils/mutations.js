...
export const UPDATE_USER2 = gql`
  mutation UpdateOtherUser($id: ID!, $firstName: String, $lastName: String, $email: String) {
    updateOtherUser(_id: $id, firstName: $firstName, lastName: $lastName, email: $email) {
      _id
    }
  }
`;
